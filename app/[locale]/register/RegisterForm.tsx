  ...
  return (
    <div style={{ background: "#fff", border: "1px solid #f0dde1", borderRadius: 24, padding: "clamp(24px,5vw,40px)", boxShadow: "0 12px 36px rgba(184,134,146,.12)" }}>
      ...
      <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        ...
        {error ? (
          <div id="register-form-error" role="alert" style={{ fontSize: 13, color: "#b94f4f", textAlign: "center", background: "#fff5f5", borderRadius: 8, padding: "8px 12px", border: "1px solid #fce8e8" }}>
            {error}
          </div>
        ) : null}
